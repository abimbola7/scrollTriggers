...
const MouseProvider = ({ children }) => {
  ...
  return (
    ...
    >
      <div className={`flair w-2 h-2 rounded-full fixed top-0 left-0 -translate-x-1/2 -translate-y-1/2 bg-black z-[100000] pointer-events-none text-center items-center justify-center flex ${mobileMode ? 'invisible' : 'visible'}`}>
      </div>
      { children }
    </div>
  )
